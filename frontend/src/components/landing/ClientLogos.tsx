  ...
  return (
    <section className="py-16 overflow-hidden relative" style={{ borderTop: "1px solid var(--cx-card-border)" }}>
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 mb-8 relative">
        <p className="cx-eyebrow" style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", textAlign: "center", fontFamily: "var(--font-mono,'JetBrains Mono',monospace)" }}>
        ...
        <div className="flex animate-marquee hover:[animation-play-state:paused]">
          {[...techs, ...techs].map((tech, index) => (
            <div key={`${tech}-${index}`} className="flex items-center justify-center min-w-[180px] px-6">
              <span className="cx-text-faint" style={{ fontSize: "clamp(13px,1.5vw,18px)", fontWeight: 600, whiteSpace: "nowrap", fontFamily: "var(--font-mono,'JetBrains Mono',monospace)", letterSpacing: "0.02em", transition: "color 0.2s ease" }}
