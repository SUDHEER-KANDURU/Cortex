...
class JobModel(Base):
    ...
    # Live pipeline progress (P1-6). Nullable/default-0 so pre-existing rows and
    # the additive startup migration stay compatible.
    progress_stage: Mapped[str | None] = mapped_column(String(120), nullable=True)
